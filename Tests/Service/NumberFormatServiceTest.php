...
namespace Dothiv\Bundle\MoneyFormatBundle\Tests\Service;
...
class NumberFormatServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Dothiv\Bundle\MoneyFormatBundle\Service\NumberFormatService', $this->getTestObject());
    }
